...
import type { PostAuthor, PostCreateInput, PostUpdateInput } from '@/shared/types/post.types';
...
/** 에디터 — 수정 (히스토리 자동 저장) */
export const updatePost = (id: string, input: PostUpdateInput, editedBy: PostAuthor) =>
  postRepository.update(id, input, editedBy);
